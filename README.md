...
Selecione Import from Self-Contained File e escolha o arquivo DB_Escola_musica_para_todos.sql.
Clique em Start Import.
Pronto! O banco DB_Escola_musica_para_todos.sql será criado com tudo pronto.
